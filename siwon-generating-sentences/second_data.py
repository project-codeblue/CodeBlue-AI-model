...
("흉부 불편감과 호흡곤란으로 인한 신경과민에 가래와 기침이 빈번하게 발생하고 있습니다.", 2),
("호흡 시 휘파람 소리가 나고, 기침과 가래로 인해 흉통이 발생하며 신경과민이 높아집니다.", 2),
("입술과 손톱의 청색증이 동반된 상태에서 호흡곤란과 가래가 지속적으로 발생하고 있습니다.", 4),
("가슴 통증에 입술 청색증이 동반되어 호흡 시 휘파람 소리가 나고 가래와 기침이 발생합니다.", 3),
("흉통과 호흡곤란이 동반된 상태에서 입술, 손톱의 청색증이 발생하며 가래와 기침이 지속됩니다.", 4),
...
("천식 발작으로 인해 호흡 걱정과 함께, 가슴이 찌르는 것 같은 통증이 있습니다.", 4),
("호흡 곤란으로 인해 기침을 하고 폐에서 가래가 많이 발생합니다.", 3),
("호흡부족으로 인해 숨쉬기가 힘들고 긴장감이 생깁니다.", 3),
("기침 유발과 함께 흉부가 답답한 느낌이 드는 경우가 있습니다.", 3),
("폐렴으로 인해 흉부가 아픈 것 같고 기침과 함께 힘겹습니다.", 4),
("호흡도 참을 수 없게 어려워져 흉부 압박감과 함께 시야가 어두워집니다.", 4),
("천식 발작으로 인해 호흡이 어려워지고, 가슴 아래에서 막힌 기분이 들면서 꼼짝이지 못합니다.", 4),
("흉통과 함께 기침이 매우 심하고, 폐에서 지속적인 적신성 가래가 발생합니다.", 4),
("호흡 곤란으로 인해 기침이 지속적이고 흉통이 생깁니다.", 3),
("흉부가 답답하고 폐에서 가래가 계속 발생하여 한숨도 못 쉴 것 같습니다.", 4),
("천식 발작으로 인해 호흡기 근육이 수축되어 어지럽고, 시야까지 어두워지는 경우도 있습니다.", 4),
("폐렴으로 인해 침과 함께 흉통이 발생하고 숨쉬기 어려워집니다.", 4),
("호흡 곤란으로 인해 공기가 마시기 힘들고 가슴 속이 답답합니다.", 3),
("가래가 발생하며 매우 기침이 심한 경우가 있습니다.", 3),
("천식으로 인해 숨쉬기가 어려워지며 흉부가 답답하고 아프기도 합니다.", 4),
("호흡 부족으로 인해 기침이 계속되고 한숨도 쉴 수 없는 상태입니다.", 3),
("폐기종으로 인해 숨쉬기가 힘들어지면서 흉부도 아파지기 시작합니다.", 4),
...
("환자는 체중감소와 피로를 호소하며 호흡곤란과 가슴 답답함이 동시에 발생하고 있다.", 4),
("환자는 두통과 가슴 통증이 함께 있고, 인후통으로 인해 흉통이 발생하고 있는 상태입니다.", 2),
...
("환자는 체중 감소와 코막힘으로 인해 인후통이 동반되고 있으며, 피로와 호흡 시 쉬익 소리가 동반되고 있다.", 4),
("호흡이 심하게 어려워 숨을 쉬는 것이 거의 불가능합니다.", 4),
("산소 공급이 부족하여 의식이 혼미하고 심한 혼란 상태입니다.", 4),
("가슴 통증과 함께 호흡이 매우 어려워 힘들게 숨을 쉴 수 있습니다.", 4),
("심한 코막힘이 동반되어 호흡이 거의 이루어지지 않습니다.", 4),
("숨을 쉬면서 실신하는 상태로 응급 조치가 필요합니다.", 4),
("호흡이 심하게 빨라져서 정상적인 호흡 패턴이 나타나지 않습니다.", 4),
("산소 부족으로 인해 의식을 잃고 혼수 상태에 빠집니다.", 4),
("호흡이 어려워 숨을 쉬는 것이 거의 불가능하며 응급 수술이 필요합니다.", 4),
("호흡이 매우 어려워 혼란과 혼돈 상태에 놓입니다.", 4),
("호흡이 거의 이루어지지 않아 심장마비와 같은 생명 위협적인 상태입니다.", 4),
